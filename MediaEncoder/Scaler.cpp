...
namespace MediaEncoder {
    ...
    Scaler::Scaler()
        : sws_ctx(nullptr), disposed(false), srcW(0), srcH(0), dstW(0), dstH(0), srcFormat(PixelFormat::None), dstFormat(PixelFormat::None), y210le_frame(nullptr), rgb_frame(nullptr)
    {
        //av_register_all();
    }
